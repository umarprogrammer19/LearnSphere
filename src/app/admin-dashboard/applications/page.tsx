...
export default function AdminApplicationsPage() {
  ...
  const handleVerifyTutor = async (uid: string) => {
   ...
   const handleRejectTutor = async (uid: string) => {
    try {
      const userRef = doc(firestore, "users", uid);
      await updateDoc(userRef, {
      ...
      toast({ title: "Teacher Rejected", description: "The teacher's application has been rejected." });
    } catch (error: any) {
                      ...
                      <TableCell className="space-x-2">
                        ...
                        >
                         ...
                         <Button
                          size="sm"
                          variant="destructive"
                          onClick={() => handleRejectTutor(app.uid)}
                        >
                          Reject
                        </Button>
                      </TableCell>
